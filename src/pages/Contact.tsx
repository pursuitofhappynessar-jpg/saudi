      ...
      <div className="py-24 bg-gradient-to-br from-gray-50 to-white min-h-screen">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-green-50 border border-green-200 rounded-2xl p-12 text-center animate-fade-in shadow-xl">
            ...
            <h3 className="text-3xl font-bold text-green-800 mb-4">تم إرسال رسالتك بنجاح!</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-8">
            يسعدنا تواصلكم معنا لأي استفسارات أو اقتراحات. يُرجى تعبئة النموذج أدناه وسنقوم بالرد في أقرب وقت.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="animate-slide-up">
            <div className="bg-white rounded-2xl shadow-xl p-8 border-t-4 border-teal-500">
              <h2 className="text-3xl font-bold text-darkBlue-800 mb-8">معلومات التواصل</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-darkBlue-800 mb-1">العنوان</h3>
                    <p className="text-gray-600">المملكة العربية السعودية - الطائف</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-darkBlue-800 mb-1">البريد الإلكتروني</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-darkBlue-800 mb-1">رقم التواصل</h3>
          ...
          <div className="animate-slide-up" style={{ animationDelay: '0.2s' }}>
            <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-8 border-t-4 border-purple-500">
              <h2 className="text-3xl font-bold text-darkBlue-800 mb-8">أرسل رسالة</h2>
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      required
                      rows={6}
                      className="w-full pr-12 pl-4 py-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-300 resize-none"
