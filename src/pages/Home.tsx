    ...
    <div>
      ...
      <section className="relative bg-gradient-to-br from-teal-600 via-purple-600 to-pink-600 text-white overflow-hidden min-h-screen flex items-center">
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute top-40 right-32 w-24 h-24 border-2 border-white rounded-full animate-pulse-slow" style={{ animationDelay: '1s' }}></div>
          <div className="absolute bottom-32 left-40 w-20 h-20 border-2 border-white rounded-full animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
          <div className="absolute bottom-40 right-20 w-28 h-28 border-2 border-white rounded-full animate-pulse-slow" style={{ animationDelay: '0.5s' }}></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="text-center animate-fade-in">
            ...
            <p className="text-xl md:text-3xl mb-12 opacity-90 leading-relaxed max-w-4xl mx-auto">
              نحو مستقبل أفضل للسياحة العلاجية في المملكة العربية السعودية
            </p>
            
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-16">
              <div className="flex items-center gap-2">
                <Calendar className="w-7 h-7 text-orange-300" />
                <span className="text-xl font-medium">يوليو 2025</span>
              </div>
              <div className="flex items-center gap-2">
                <MapPin className="w-7 h-7 text-orange-300" />
                <span className="text-xl font-medium">الطائف، المملكة العربية السعودية</span>
              </div>
              <div className="flex items-center gap-2">
                <Users className="w-7 h-7 text-orange-300" />
                <span className="text-xl font-medium">أكثر من 500 مشارك</span>
              </div>
            </div>
            ...
            {[
              {
                ...
                title: 'رؤيتنا',
                description: 'أن نكون الرائدة في تطوير قطاع السياحة العلاجية وتعزيز التنمية المستدامة',
                color: 'teal'
              },
              {
                icon: <Heart className="w-8 h-8" />,
                title: 'رسالتنا',
                description: 'تمكين المجتمعات المحلية من خلال الخدمات الطبية المتميزة والسياحة العلاجية',
                color: 'purple'
              },
              {
                icon: <Award className="w-8 h-8" />,
                title: 'قيمنا',
                description: 'الشفافية والمسؤولية والتميز في جميع أعمالنا الطبية والسياحية',
                color: 'orange'
              },
              {
                icon: <Globe className="w-8 h-8" />,
                title: 'تأثيرنا',
                description: 'خدمة أكثر من 10,000 مستفيد في جميع أنحاء المملكة والعالم',
                color: 'pink'
              }
            ].map((feature, index) => (
              <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Link to="/conference" className="group">
              <div className="bg-gradient-to-br from-teal-500 to-teal-600 p-8 rounded-2xl text-white transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                ...
                <h3 className="text-2xl font-bold mb-3">المؤتمر</h3>
                <p className="opacity-90">اكتشف برنامج المؤتمر والمتحدثين المميزين</p>
              </div>
            </Link>
            <Link to="/hospitality" className="group">
              <div className="bg-gradient-to-br from-purple-500 to-purple-600 p-8 rounded-2xl text-white transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                ...
                <h3 className="text-2xl font-bold mb-3">الضيافة</h3>
                <p className="opacity-90">خدمات الإقامة والضيافة للمشاركين</p>
              </div>
            </Link>
            <Link to="/partners" className="group">
              <div className="bg-gradient-to-br from-orange-500 to-orange-600 p-8 rounded-2xl text-white transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                ...
                <h3 className="text-2xl font-bold mb-3">الشركاء</h3>
                <p className="opacity-90">تعرف على شركائنا والفرص المتاحة</p>
              </div>
            </Link>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
            {[
              { icon: <Calendar className="w-12 h-12" />, number: '3', label: 'أيام', color: 'teal' },
              { icon: <Users className="w-12 h-12" />, number: '500+', label: 'مشارك', color: 'purple' },
              { icon: <Award className="w-12 h-12" />, number: '25', label: 'متحدث', color: 'orange' },
              { icon: <Stethoscope className="w-12 h-12" />, number: '15', label: 'جلسة', color: 'pink' }
            ].map((stat, index) => (
              <div 
                key={index}
