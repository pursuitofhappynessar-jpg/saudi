...
const ConferenceProgramEn = () => {
  const programData = [
    ...
    },
    {
      ...
      speakers: "Saud Bin Nahar (سعود بن نهار), Christoph Weigel (كريستوف ويجل)"
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-8">
            Annual Medical Tourism Conference agenda with topics and distinguished speakers
          </p>
        </div>
          ...
          <div className="bg-gradient-to-r from-teal-600 to-purple-600 p-6">
            <div className="flex items-center justify-center gap-8 text-white">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg font-medium">3 Days</span>
              </div>
              <div className="flex items-center gap-2">
                <Users className="w-6 h-6" />
                <span className="text-lg font-medium">8 Sessions</span>
              </div>
            </div>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-6 py-4 text-left text-sm font-bold text-darkBlue-800 uppercase tracking-wider border-b">
                    Topic (English)
                  </th>
                  <th className="px-6 py-4 text-left text-sm font-bold text-darkBlue-800 uppercase tracking-wider border-b">
                    الموضوع (عربي)
        ...
        <div className="mt-12 text-center">
          <div className="bg-gradient-to-br from-teal-50 to-purple-50 rounded-2xl p-8 max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-darkBlue-800 mb-4">Additional Information</h3>
            <p className="text-gray-600 leading-relaxed">
              More details about specific timings for each session will be announced soon. 
              Please follow the website for the latest updates.
            </p>
          </div>
        </div>
      </div>
...
export default ConferenceProgramEn;