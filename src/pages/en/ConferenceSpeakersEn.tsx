...
const ConferenceSpeakersEn = () => {
  const speakers = [
    ...
    { name: "Saud Bin Nahar", nameAr: "سعود بن نهار" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-8">
            A selection of experts and specialists in the field of medical tourism from around the world
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="text-center p-8 bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl animate-slide-up shadow-lg">
            ...
            <p className="text-gray-600 font-medium">Distinguished Speakers</p>
          </div>
          <div className="text-center p-8 bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl animate-slide-up shadow-lg" style={{ animationDelay: '0.1s' }}>
            ...
            <p className="text-gray-600 font-medium">Different Countries</p>
          </div>
          <div className="text-center p-8 bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl animate-slide-up shadow-lg" style={{ animationDelay: '0.2s' }}>
            ...
            <p className="text-gray-600 font-medium">Years of Combined Experience</p>
          </div>
        </div>
              ...
              <div className="p-6 text-center">
                <div className="mb-4">
                  <img 
                    src="/logo.png" 
                    alt={speaker.name}
                    className="h-16 w-auto mx-auto opacity-60 drop-shadow-sm logo-glow"
                  />
                </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 animate-fade-in">
          <div className="text-center mb-8">
            <h3 className="text-3xl font-bold text-darkBlue-800 mb-4">About the Speakers</h3>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              The conference brings together a selection of experts and specialists in the field of medical tourism from the Kingdom of Saudi Arabia and various countries around the world
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl p-6">
              <h4 className="text-xl font-bold text-teal-800 mb-3">Local Expertise</h4>
              <p className="text-gray-700 leading-relaxed">
                Speakers from the Kingdom of Saudi Arabia with extensive experience in developing the medical tourism sector locally
              </p>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6">
              <h4 className="text-xl font-bold text-purple-800 mb-3">International Expertise</h4>
              <p className="text-gray-700 leading-relaxed">
                International experts from different continents sharing their successful experiences in the field of medical tourism
              </p>
            </div>
          </div>
        </div>
...
export default ConferenceSpeakersEn;