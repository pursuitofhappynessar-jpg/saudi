    ...
    <Router>
      <Routes>
        ...
        <Route path="/" element={<Layout />}>
          ...
          <Route path="about/conference" element={<PlaceholderPage title="عن المؤتمر" description="معلومات تفصيلية عن المؤتمر السنوي للسياحة العلاجية" />} />
          ...
          <Route path="conference/who-should-attend" element={<PlaceholderPage title="من يجب أن يحضر" description="الفئات المستهدفة والمستفيدة من المؤتمر" />} />
          ...
          <Route path="hospitality/visa" element={<PlaceholderPage title="متطلبات التأشيرة" description="معلومات عن متطلبات التأشيرة للمشاركين الدوليين" />} />
          <Route path="hospitality/flights" element={<PlaceholderPage title="الرحلات الجوية" description="معلومات عن الرحلات الجوية والمواصلات" />} />
        ...
        <Route path="/en" element={<LayoutEn />}>
          ...
          <Route path="about/conference" element={<PlaceholderPageEn title="About the Conference" description="Detailed information about the Annual Medical Tourism Conference" />} />
          ...
          <Route path="conference/who-should-attend" element={<PlaceholderPageEn title="Who Should Attend" description="Target groups and beneficiaries of the conference" />} />
          ...
          <Route path="hospitality/visa" element={<PlaceholderPageEn title="Visa Requirements" description="Information about visa requirements for international participants" />} />
          <Route path="hospitality/flights" element={<PlaceholderPageEn title="Flights" description="Information about flights and transportation" />} />
